              ...
              <div class="span4">
                <div class="box aligncenter">
                  <div class="icon">
                    ...
                    <i class="ico icon-arrow-up icon-5x"></i>
                  </div>
                  <div class="text">
        ...
        <div class="row">
          <div class="span12">
            <div class="row">
              <div class="span12">
                <div class="aligncenter">
                  <h3>Most Recent Opportunities</h3>
                  <blockquote>
            ...
            <div class="row">
              ...
              <div class="span3">
                <h5>Do Not Miss The Moment</h5>
                <p>
                    On YouVest, opportunities come again and again,
                    but they get sold out very quickly. Only those who
                    jump in quickly get to enjoy the juice.
                </p>
                <p>
                    Karen Lamb said; 
                    <strong>
                    ...
                    But we say, a day from now, you may wish you started right now.
                </p>
              </div>
    ...
    <section id="works">
      <div class="container">
        <div class="row">
          <div class="span12">
            <h3>Empowered By</h3>
            <p>Your funds and data are protected by:</p>
            <div class="row">
        ...
        <div class="row">
          <div class="span4">
            <div class="widget">
              ...
              <address>
							  <strong>You International.</strong><br>
  							No. 5 Joseph Lambo<br>
  							Costain Lagos
  						</address>
              <p>
                <i class="icon-phone"></i> 08039101861 <br>
                <i class="icon-envelope-alt"></i> info@youvest.com.ng
              </p>
            </div>
          </div>
          <div class="span4">
          ...
          <div class="span4">
            <div class="widget">
              <h5 class="widgetheading">Our Instagram</h5>

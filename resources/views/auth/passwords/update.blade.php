                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store-password') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror rounded-0" name="password_confirmation" required autocomplete="current-password">

...
Route::get('/verify/{reference}', 'HomeController@verify_payment')->name('verify')->middleware('auth');
// profile
...
Route::get('/category/{id}', 'CategoryController@category')->name('category')->middleware('auth');
